...
public class Aerolinea
{
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        for (Vuelo vuelo : vuelos) {
            if (vuelo.getAvion().equals(avion) && vuelo.getFecha().equals(fecha)) {
                throw new Exception("El avión " + nombreAvion + " ya está programado para otro vuelo en la misma fecha.");
            }
        }
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        LocalDate fechaa = LocalDate.parse(fecha, formatter);
	...
	public Aeropuerto getAeropuerto(String codigo) {
	    for (Ruta ruta : rutas.values()) {
	        if (ruta.getOrigen().getCodigo().equals(codigo)) {
	            return ruta.getOrigen();
	        } else if (ruta.getDestino().getCodigo().equals(codigo)) {
